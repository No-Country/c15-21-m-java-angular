...
public class EmailService {
    ...
    public void sendEcoTiendaConfirmationEmail(String to, String confirmationLink, String username) throws MessagingException, IOException {
        ...
        String imagePath = "static/LogoEcoTienda.png";
        ...
        if (inputStream != null) {
            ...
            System.err.println("Error: Unable to find the image resource at path: " + imagePath);
            throw new IOException("Unable to find the image resource at path: " + imagePath);
        }
    }
}